...
IsotypicMultiplicitySymmetricPower[\[Lambda]_?NonNegativeIntegerQ,d_?NonNegativeIntegerQ,\[Mu]_?NonNegativeIntegerQ]:=
...
IsotypicMultiplicitySchurPower[\[Lambda]_?NonNegativeIntegerQ,p_?IntegerPartitionQ,\[Mu]_?NonNegativeIntegerQ]:=
 With[
...
IsotypicComponentsSchurPower[\[Lambda]_?NonNegativeIntegerQ,p_?IntegerPartitionQ]:=
 Select[
...
ConstrainedIsotypicComponentsExteriorPowers[\[Lambda]_?NonNegativeIntegerQ,p_?IntegerPartitionQ,\[Mu]_?NonNegativeIntegerQ]:=
 Select[
