...
IsotypicComponentTensorProductQ[\[Lambda]s_List?VectorQ,\[Mu]_Integer?NonNegative]:=
 With[
...
IsotypicMultiplicityExteriorPower[\[Lambda]_Integer?NonNegative,d_Integer?NonNegative,\[Mu]_Integer?NonNegative]:=
...
IsotypicComponentsTensorProduct[\[Lambda]_Integer?NonNegative,\[Mu]_Integer?NonNegative]:=
 Range[
  Abs[\[Lambda]-\[Mu]],
  \[Lambda]+\[Mu]
 ]
...
IsotypicComponentsTensorPower[\[Lambda]_Integer?NonNegative,d_Integer?NonNegative]:=
 If[
  d==1,
  {\[Lambda]},
  Range[0,\[Lambda]*d]
